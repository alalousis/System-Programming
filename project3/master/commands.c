...
void diseaseFrequency(struct bucket **diseaseHashtable, int diseaseHashtableSize, int entriesPerBucket, char *disease, char *d1, char *d2, char *country, char *message, int newsock){
    ...
    if(write(newsock, message, messageSize) != messageSize){
        perror("error in writing message");
    }
}

void topAgeRanges(struct bucket **diseaseHashtable, int diseaseHashtableSize, int entriesPerBucket, int k, char *disease, char *country, char *d1, char *d2, char *message, int newsock){
...
void searchByID(struct listNode **recordsHashtable, int recordsHashtableSize, char *ID, char *message, int newsock){
...
void numPatientAdmissions(struct bucket **countryHashtable, int countryHashtableSize, int entriesPerBucket, char *disease, char *d1, char *d2, char *country, char *message, int newsock){
    int i, j, counter, messageSize;
    char result[4];
    struct bucket *currentBucket;
    struct date date1, date2;
...
void numPatientDischarges(struct bucket **countryHashtable, int countryHashtableSize, int entriesPerBucket, char *disease, char *d1, char *d2, char *country, char *message, int newsock){
    int i, j, counter, messageSize;
    char result[4];
    struct bucket *currentBucket;
    struct date date1, date2;
